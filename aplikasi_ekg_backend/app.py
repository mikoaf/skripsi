...
CONNECTION_STRING = "mongodb://mikoalfandi2801:{}@ac-ot6qz3s-shard-00-00.0lhj5a0.mongodb.net:27017,ac-ot6qz3s-shard-00-01.0lhj5a0.mongodb.net:27017,ac-ot6qz3s-shard-00-02.0lhj5a0.mongodb.net:27017/?ssl=true&replicaSet=atlas-chy1ff-shard-0&authSource=admin&retryWrites=true&w=majority".format(pass_mongo)
...
@socketio.event()
def ekg():
    socketio.start_background_task(background_thread('resp_ekg', last_ekg_id, db_ekg))

@socketio.event()
def ekg_graph():
    socketio.start_background_task(background_thread('resp_ekg_graph', last_ekg_id, db_ekg))
